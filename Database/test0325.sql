...
values(9100,'김구','대통령',NULL,sysdate,99999,9999,null);
...
--(+) null값 포함
--full outer join 또한 모든값을 포함한다 null까지
...
CREATE TABLE emp4(
	...
	ename varchar2(50) CONSTRAINT emp4_ename_nn NOT null,
	sal number(7) CONSTRAINT emp4_sal_ck check(sal=5000),
	empid varchar2(20) CONSTRAINT emp4_empid_uk UNIQUE,
...
ALTER TABLE emp4
DROP constraint emp4_sal_ck;

ALTER TABLE emp4
ADD CONSTRAINT emp4_sal_ck
check(sal >= 5000 AND sal<=9999999);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(1,'홍1',5000,'hid1',10);

INSERT INTO emp4(empno,ename,sal,empid,hiredate,deptno)
values(2,'홍2',5002,'hid2','2021/12/29',10);

INSERT INTO emp4(empno,ename,sal,empid,hiredate,deptno)
values(3,'홍3',5003,'hid3','',10);

INSERT INTO emp4(empno,ename,sal,empid,hiredate,deptno)
values(4,'홍4',5004,'hid4',null,10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(5,'홍1',5005,'hid5',10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(6,'홍6',5000,'hid6',10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(7,'홍7',9999999,'hid7',10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(8,'홍8',5000,'hid8',10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(9,'홍9',null,'hid9',10); -- check는 NULL 가능

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(10,'홍10',5010,null,10); -- UNIQUE NULL 가능

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(11,'홍11',5011,'hid11',10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(12,'홍12',5012,'hid12',20);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(13,'홍13',5013,'hid13',30);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(14,'홍14',5014,'hid14',40);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(15,'홍15',5015,'hid15',null);
...
INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(null,'홍5',5005,'hid5',10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(4,'홍5',5005,'hid5',10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(8,'홍8',8,'hid8',10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(10,'홍10',5010,'hid9',10);

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(12,'홍12',5012,'hid12',12);
...
/* create sequence 이름
 * start with 값 -어디서부터
 * increment by 값 -얼마씩 증가
 * max/minvalue 값 - 최소,최대 어디까지
 * (no)cycle -사이클 돔?
 * (no)cache - 캐시는? 
 */
...
INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(seq_empno.NEXTVAL,'시퀀스1',5017,null,null); -- 24까지 들어가고 더 추가하려고 하면 에러
...
INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(seq_empno.NEXTVAL,'시퀀스-수정후2',5017,null,null); 

INSERT INTO emp4(empno,ename,sal,empid,deptno)
values(seq_empno.NEXTVAL,'시퀀스-수정후3',5017,null,null); 
